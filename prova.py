...
Original file is located at
    https://colab.research.google.com/drive/15VJz0Hj1uHmY_lBjSoiVjO_6eMQ0nFYR
"""

'''1. O Reflorestador (Loop com Acumulador)
 Em um mini-game de reflorestamento, o jogador deve plantar árvores até atingir uma meta de "Biomassa". Crie um programa que peça ao usuário a meta de biomassa (em unidades).
...
biomassa = int(input("Digite a biomassa da árvore: "))
while massa < meta:
  massa += biomassa
  arvores += 1
print(f"Você precisou plantar {arvores} árvores para chegar em {meta} biomassa")
...
mvida = 100
rodada = 1
while hvida > 0 and mvida > 0:
  print(f"Rodada {rodada}")
  hdano = int(input("Digite o dano do ataque do herói: "))
  mdano = int(input("Digite o dano do ataque do monstro: "))
  hvida -= mdano
  mvida -= hdano
  rodada += 1
  print(f"Vida do herói: {hvida}")
  print(f"Vida do monstro: {mvida}")
  if hvida <= 0:
    print("O monstro ganhou o duelo")
  if mvida <= 0:
    print("O herói ganhou o duelo")
...
nivel = int(input("Digite o nível do rio: "))
while nivel >= 0:
  if nivel < 3:
    print("Estado Normal")
...
pesototal = 0
while pesototal <= 15:
  peso = float(input("Digite qual o peso do item encontrado: "))
  itens += 1
  pesototal += peso
  if pesototal == 15:
    print(f"Você está carregando {itens} na sua mochila, totalizando {pesototal} kilos")
    break
  if pesototal > 15:
    itens -= 1
    pesototal -= peso
...
Ao final, o programa deve exibir a média aritmética das temperaturas e informar se a média está "Acima do esperado" (caso seja maior que 25°C) ou "Dentro da normalidade".'''
resultado = 0
media = 0
dia = 1
dias = int(input("Digite quantos dias deseja analisar: "))
while dia <= dias:
  temperatura = float(input(f"Digite a temperatura do {dia} dia em celsius: "))
  dia += 1
  media += temperatura
resultado = media / dias
print(f"A média de temperatura é de {resultado} graus")
if resultado > 25:
